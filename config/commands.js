...
var commands = exports.commands = {
	...
	dexsearch: function (target, room, user) {
		...
		if (!target) return this.parse('/help dexsearch');ule
	...
	rules: function(target, room, user) {
		...
		if (target.length > 40) {
			return this.sendReply('Error: Room rules link is too long (must be under 20 characters). You can use a URL shortener to shorten the link.');
		}
